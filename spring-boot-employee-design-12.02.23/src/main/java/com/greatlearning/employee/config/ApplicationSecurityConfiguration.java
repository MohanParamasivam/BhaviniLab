...
public class ApplicationSecurityConfiguration extends WebSecurityConfigurerAdapter {
	...
	public void configure(HttpSecurity http) throws Exception {
		...
		http.authorizeRequests().antMatchers(HttpMethod.GET, "/api/employees/**")
				.hasAnyRole("USER", "ADMIN").antMatchers("/h2-console/**", "/login**").permitAll().and()
				.authorizeRequests().antMatchers(HttpMethod.POST, "/api/employees/setuser/**").hasRole("ADMIN")
